...
public class UserRestController {
    ...
    public ResponseEntity<UserModel> updateUser(@Valid @RequestBody UserModel userModel) {
        ...
        return ResponseUtil.wrapOrNotFound(updatedUser,
            HeaderUtil.createAlert(applicationName, "userManagement.updated", userModel.getLogin()));
    }
     ...
     */
    @GetMapping("/users")
    public ResponseEntity<List<UserModel>> getAllUsers(@RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder, Pageable pageable) {
